        ...
        <ul class="custom-scrollbar">
            ...
            <li>
                <div class="logo-wrapper waves-light">
                    <a href="#"><img src="../../assets/pic/luk.png"
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    ...
                    <li><a class="collapsible-header waves-effect arrow-r" href="../rooms/index.php" ><i class="fad fa-box-full"
                                style="font-size:25px; margin-right:20px;"></i> Room</a>
                    </li>
